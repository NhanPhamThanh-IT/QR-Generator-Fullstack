...
/**
 * Hero section data for the documentation page
 */
...
/**
 * Document sections with navigation items
 */
    ...
    documents: [
        {
            ...
            items: [
                {
                    title: 'Introduction',
                    path: buildPath(gettingStartedRoutes, '/', routePaths.docsIntroduction)
                },
                {
                    title: 'Quick Start Guide',
                    path: buildPath(gettingStartedRoutes, '/', routePaths.docsQuickStart)
                },
                {
                    title: 'Installation',
                    path: buildPath(gettingStartedRoutes, '/', routePaths.docsInstallation)
                },
            ],
        },
        {
            ...
            items: [
                {
                    ...
                    path: buildPath(coreFeaturesRoutes, '/', routePaths.docsAITools)
                },
                {
                    title: 'Text Generation',
                    path: buildPath(coreFeaturesRoutes, '/', routePaths.docsTextGeneration)
                },
                {
                    title: 'Image Processing',
                    path: buildPath(coreFeaturesRoutes, '/', routePaths.docsImageProcessing)
                },
            ],
        },
        {
        ...
        },
        {
            ...
            items: [
                {
                    title: 'Common Issues',
                    path: buildPath(troubleshootingRoutes, '/', routePaths.docsCommonIssues)
                },
                {
                    title: 'Error Codes',
                    path: buildPath(troubleshootingRoutes, '/', routePaths.docsErrorCodes)
                },
                {
                    title: 'FAQ',
                    path: buildPath(troubleshootingRoutes, '/', routePaths.docsFAQ)
                },
            ],
        },
    ]
