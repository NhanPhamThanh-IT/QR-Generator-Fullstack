/**
 * DocumentationHeroSection Component
 * 
...
export const DocumentationHeroSection = ({
    title,
    description,
    leftChildren,
    rightChildren,
    ...
    const backgroundStyle = backgroundImage
        ...
        : `linear-gradient(135deg, ${theme.palette.primary.light} 0%, ${theme.palette.info.main} 100%)`;
...
export default DocumentationHeroSection;
